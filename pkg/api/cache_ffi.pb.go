...
// =============================================================================
// CacheService FFI Server Interface
// =============================================================================

type CacheServiceFfiServer interface {
	CacheServiceServer
}

// =============================================================================
// CacheService Invoke - returns []byte (for TCP/UDS)
// =============================================================================

func CacheServiceInvoke(s CacheServiceFfiServer, ctx context.Context, method string, data []byte) ([]byte, error) {
	switch method {
...
// =============================================================================
// CacheService InvokeFfi - returns C pointer (for zero-copy FFI)
// =============================================================================

// CacheServiceInvokeFfi is the zero-copy variant for FFI mode.
// It allocates C memory and serializes directly into it.
// Caller is responsible for freeing the returned pointer via C.free().
func CacheServiceInvokeFfi(s CacheServiceFfiServer, ctx context.Context, method string, data []byte) (unsafe.Pointer, int64, error) {
	switch method {
	case "/core.v1.CacheService/Get":
		req := &GetCacheRequest{}
		if err := proto.Unmarshal(data, req); err != nil {
...
// =============================================================================
// CacheService FFI Invoker - wraps CacheServiceFfiServer
// =============================================================================

// cacheServiceFfiInvoker wraps CacheServiceFfiServer to implement the synurang.Invoker interface.
...
type cacheServiceFfiInvoker struct {
	server CacheServiceFfiServer
}

// Invoke implements synurang.UnaryInvoker (zero-copy).
func (i *cacheServiceFfiInvoker) Invoke(ctx context.Context, method string, req, reply proto.Message) error {
	switch method {
	case "/core.v1.CacheService/Get":
...
func (i *cacheServiceFfiInvoker) InvokeStream(ctx context.Context, method string, stream synurang.ServerStream) error {
	switch method {
	default:
...
var _ synurang.Invoker = (*cacheServiceFfiInvoker)(nil)

// =============================================================================
// CacheService FFI Client - convenience wrapper for synurang.FfiClientConn
// =============================================================================

func NewCacheServiceFfiClientConn(server CacheServiceFfiServer) grpc.ClientConnInterface {
	return synurang.NewFfiClientConn(&cacheServiceFfiInvoker{server: server})
}
