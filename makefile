...
help:
	...
	@echo "  make docker_android_aar AAR_VERSION=0.7.2 # Build core + grpc AAR bundles"
	@echo "  make docker_android_aar_debug AAR_VERSION=0.7.2-SNAPSHOT # Build debug AAR bundles"
